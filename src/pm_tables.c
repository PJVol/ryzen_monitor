...
void pm_table_0x400005(pm_table *pmt, void* base_addr) {
    ...
    pmt->STT_LIMIT_APU =         pm_element(21);
    ...
    pmt->PSI0_LIMIT VDD =        pm_element(30);
    pmt->PSI0_RESIDENCY VDD =    pm_element(31); 
    pmt->PSI0_LIMIT SOC =        pm_element(32);
    pmt->PSI0_RESIDENCY SOC =    pm_element(33); 	
    ...
    pmt->GLOBAL_FREQUENCY =      pm_element(39);
    pmt->STAPM_FREQUENCY =       pm_element(40);
    pmt->PPT_FAST_FREQ =         pm_element(41);
    pmt->PPT_SLOW_FREQ =         pm_element(42);
    pmt->PPT_APU_FREQ =          pm_element(43);
    pmt->TDC_FREQ =              pm_element(44);
    pmt->THM_FREQ =              pm_element(45);
    pmt->HTFMAX_FREQ =           pm_element(46);
    pmt->PROCHOT_FREQ =          pm_element(47);
    pmt->VOLTAGE_FREQ =          pm_element(48);
    pmt->CCA_FREQUENCY =         pm_element(49);
    pmt->GFX_GLOBAL_FREQ =       pm_element(50);
    pmt->GFX_STAPM_FREQ =        pm_element(51);
    pmt->GFX_PPT_FAST_FREQ =     pm_element(52);
    pmt->GFX_PPT_SLOW_FREQ =     pm_element(53);
    pmt->GFX_PPT_APU_FREQ =      pm_element(54);
    pmt->GFX_TDC_FREQ =          pm_element(55);
    pmt->GFX_THM_FREQ =          pm_element(56);
    pmt->GFX_HTFMAX_FREQ =       pm_element(57);
    pmt->GFX_PROCHOT_FREQ =      pm_element(58);
    pmt->GFX_VOLTAGE_FREQ =      pm_element(59);
    pmt->GFX_CCA_FREQ =          pm_element(60);
    pmt->GFX_DEM_FREQ =          pm_element(61);	
    ...
    pmt->LCLK_SETPOINT =         pm_element(76);
    pmt->LCLK_BUSY =             pm_element(77);
    ...
    pmt->MAX_DRAM BANDWIDTH    = pm_element(192);
    ...
    pmt->L3_LOGIC_POWER =        pm_element(384);
    pmt->L3_VDDM_POWER =         pm_element(385);
    pmt->L3_TEMP =               pm_element(386);
    pmt->L3_FIT =                pm_element(387);
    pmt->L3_IDDMAX =             pm_element(388);
    pmt->L3_FREQ =               pm_element(389);
    pmt->L3_FREQ_EFF =           pm_element(390);
    pmt->L3_CKS_FDD =            pm_element(391);
    pmt->L3_CCA_THRESHOLD =      pm_element(392);
    pmt->L3_CCA_CAC =            pm_element(393);
    pmt->L3_CCA_ACTIVATION =     pm_element(394);
    pmt->L3_EDC_LIMIT =          pm_element(395);
    pmt->L3_EDC_CAC =            pm_element(396);
    pmt->L3_EDC_RESIDENCY =      pm_element(397);
    pmt->L3_FLL_BTC =            pm_element(398);                                       
    ...
    pmt->MCLK_FREQ             = pm_element(411);
    pmt->VCLK_FREQ             = pm_element(412);
    pmt->DCLK_FREQ             = pm_element(413);
    pmt->SOCCLK_FREQ           = pm_element(414);
    pmt->LCLK_FREQ             = pm_element(415);
    pmt->SHUB_FREQ             = pm_element(416);
    pmt->MP0_FREQ              = pm_element(417);
    pmt->DCF_FREQ              = pm_element(418);
    pmt->FCLK_FREQ_EFF         = pm_element(419);
    pmt->UCLK_FREQ_EFF         = pm_element(420);
    pmt->MCLK_FREQ_EFF         = pm_element(421);
    pmt->VCLK_FREQ_EFF         = pm_element(422);
    pmt->DCLK_FREQ_EFF         = pm_element(423);
    pmt->SOCCLK_FREQ_EFF       = pm_element(424);
    pmt->LCLK_FREQ_EFF         = pm_element(425);
    pmt->SHUB_FREQ_EFF         = pm_element(426);
    pmt->MP0_FREQ_EFF          = pm_element(427);
    ...
    pmt->CLDO_VDDM             = pm_element(564);
    pmt->CLDO_VDDP             = pm_element(565);
    pmt->DDR_PHY_POWER         = pm_element(566);
    pmt->IO_VDDIO_MEM_POWER    = pm_element(567);
